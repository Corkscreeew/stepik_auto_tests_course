...
try:
    ...
    input4 = browser.find_element(By.XPATH, '//label[contains(text(), "Phone:")]/following-sibling::input')
    input5 = browser.find_element(By.XPATH, '//label[contains(text(), "Address:")]/following-sibling::input')
    input1.send_keys("Test")
    input2.send_keys("Test2")
    input3.send_keys("xx@xx.xx")
    input4.send_keys("711111111111")
    input5.send_keys("11111bbb")
